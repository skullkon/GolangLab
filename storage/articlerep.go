...
func (ar *ArticleRep) Create(a *models.Article) (*models.Article, error) {
...
func (ar *ArticleRep) DeleteById(id int) (*models.Article, error) {
...
func (ar *ArticleRep) FindArticleById(id int) (*models.Article, bool, error) {
...
func (ar *ArticleRep) SelectAll() ([]*models.Article, error) {
